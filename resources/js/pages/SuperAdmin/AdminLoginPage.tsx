...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#F8FAFC] font-sans selection:bg-violet-600 selection:text-white">
      ...
      <div className="relative hidden lg:flex flex-col justify-between w-[48%] min-h-screen bg-[#090E1A] p-12 lg:p-16 overflow-hidden">
        ...
        <div className="absolute -top-32 -left-32 w-96 h-96 bg-violet-600/30 rounded-full blur-[100px] pointer-events-none animate-pulse" style={{ animationDuration: '6s' }} />
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-violet-600 to-blue-500 flex items-center justify-center shadow-lg shadow-violet-600/25 transition-all duration-300 hover:scale-105 cursor-pointer">
        ...
        <div className="relative z-10 my-auto py-6">
          ...
          <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-400/30 backdrop-blur-md shadow-[0_0_20px_rgba(139,92,246,0.15)] mb-6 transition-all hover:bg-violet-500/15 hover:border-violet-400/50">
            <Layers size={15} className="text-violet-400" />
            <span className="text-[12px] font-extrabold tracking-[0.16em] text-violet-300 uppercase">
          ...
          <p className="text-slate-300/85 text-[15px] lg:text-[15.5px] leading-relaxed max-w-lg font-normal">
            Unified platform for system administration, user management, role assignments, and global audit logging.
          </p>
        </div>
      </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3.5 py-2.5 rounded-xl border text-[14px] outline-none transition-all duration-200
                  ${error ? 'border-danger focus:ring-4 focus:ring-danger/15' : 'border-slate-200 focus:border-violet-600 focus:ring-4 focus:ring-violet-600/10'}
            ...
            <button
              ...
              className={`group w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl
                ...
                ${loading
                  ...
                  : 'bg-violet-600 hover:bg-violet-600-dark active:scale-[0.99] hover:shadow-lg hover:shadow-violet-600/25'}`}
            >
              {loading ? (
                <>
