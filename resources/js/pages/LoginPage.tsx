        ...
        router.post(
            ...
            { email, password },
            {
                onError: (err) => {
                    setLoading(false);
                    setError(
                        err.email || "Invalid credentials. Please try again.",
                    );
                },
        ...
        <div className="min-h-screen flex flex-col lg:flex-row bg-neutral-50">
            ...
            <div className="hidden lg:flex flex-col justify-between w-[46%] min-h-screen bg-sidebar p-12">
                ...
                <div>
                    ...
                    <p className="text-white/60 text-[15px] leading-relaxed max-w-sm">
                        From scheduling and S-Curve analysis to budget
                        monitoring — all your project workflows in one place.
                    </p>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center p-6 lg:p-16">
                <div className="w-full max-w-sm">
                    ...
                    <div className="mb-8">
                        <h2 className="text-2xl font-bold text-neutral-900 mb-1.5">
                            Welcome back
                        </h2>
