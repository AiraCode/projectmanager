...
export const PROJECT: Project = {
  ...
  mainJobs: [
    ...
    },
    {
      ...
      status: 'Completed',
      subMainJobs: [
        { id: 'smj-3-1', code: '3.1', name: 'SIPIL WORKS DESIGN, SPEC & RAB', pic: 'Engineering', startDate: '2024-06-01', finishDate: '2024-08-31', progress: 100, status: 'Completed', weight: 2, subtasks: [] },
        { id: 'smj-3-2', code: '3.2', name: 'SIPIL PROJECT SCHEDULE', pic: 'PM', startDate: '2024-07-01', finishDate: '2024-08-31', progress: 100, status: 'Completed', weight: 1, subtasks: [] },
    ...
    },
    {
      ...
      status: 'On Track',
      subMainJobs: [
        { id: 'smj-6-1', code: '6.1', name: 'PURCHASING RELATED TO SIPIL WORKS', pic: 'Purchasing', startDate: '2024-08-01', finishDate: '2025-11-30', progress: 100, status: 'Completed', weight: 2.5, subtasks: [] },
...
function generateBudgetEntries(): BudgetEntry[] {
  return [
    ...
    { id: 'b-05', tanggal: '2025-02-20', codeSubWbs: '4.1', subTaskWbs: 'Production Machine Procurement', kategori: 'Mesin', lokasi: 'Gudang B', namaItem: 'Injection Molding Machine 500T', spesifikasi: 'Imported, 500 Ton clamp force', qty: 4, satuan: 'unit', hargaSatuan: 3200000000, hargaTotal: 12800000000, referensi: 'PO-2025-0201', keterangan: 'Mesin utama produksi' },
    ...
    { id: 'b-08', tanggal: '2026-03-14', codeSubWbs: '4.3', subTaskWbs: 'Machine Shipping', kategori: 'Logistik', lokasi: 'Pelabuhan Tg Priok', namaItem: 'Biaya Freight Mesin Produksi', spesifikasi: 'FCL, Sea Freight', qty: 1, satuan: 'LS', hargaSatuan: 850000000, hargaTotal: 850000000, referensi: 'INV-FWD-0314', keterangan: 'Dari pelabuhan China' },
